...
export const metadata: Metadata = {
  title: "عن الموقع - كهربائي صنعاء",
  description:
    "معلومات حول خدمات كهربائي صنعاء والتقنيات الحديثة المستخدمة في بناء الموقع.",
};
          ...
          <div className="glass p-8 rounded-xl space-y-10">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-400 space-y-2">
                ...
                <li>تتبع حركة الماوس بدقة عالية</li>
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                تم تحسين الموقع لتحقيق أعلى أداء ممكن مع الحفاظ على جودة الرسوميات،
                باستخدام تقنيات مثل postprocessing الذكي، وتحسين استهلاك الذاكرة،
                وتحميل الموارد بكفاءة عالية.
              </p>
            </div>
          </div>
        </motion.div>
